...
CMD='python run_walkforward.py --dataset_dir "data/processed/2000_2026_1d_90_15" --bonus_ratio 0.15 --min_delta 0.001 --runs 30 --batch_size 2048 --epochs 100 --l2_reg "1e-3" --lr "8e-2" --start_fold "fold_2010" --append'
